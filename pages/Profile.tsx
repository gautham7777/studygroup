...
import { LearningStyle, StudyMethod } from '../types';
...
const Profile: React.FC = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-surface p-8 rounded-lg shadow-lg">
            ...
            {notification && <div className="bg-secondary text-on-secondary p-3 rounded-md mb-4">{notification}</div>}
            <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                    ...
                    />
                    <button type="button" onClick={handleGenerateBio} disabled={isGeneratingBio} className="mt-2 text-sm text-primary font-semibold hover:underline disabled:opacity-50 disabled:cursor-not-allowed">
                ...
                <div className="flex justify-end">
                    <button type="submit" className="bg-primary text-white px-6 py-2 rounded-md hover:bg-primary/90 transition-colors font-medium">Save Profile</button>
                </div>
            </form>
        </div>
    );
